...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASEMODLIBS': '',
 'BINDIR': '/workspaces/LLM-Invoice-Extractor/venv/bin',
 'BINLIBDEST': '/workspaces/LLM-Invoice-Extractor/venv/lib/python3.12',
 'BLDLIBRARY': 'libpython3.12.a',
 'BLDSHARED': 'gcc -pthread -B /workspaces/LLM-Invoice-Extractor/venv/compiler_compat -shared  '
              ''
              ''
              '-Wl,-rpath,/workspaces/LLM-Invoice-Extractor/venv/lib '
              '-Wl,-rpath-link,/workspaces/LLM-Invoice-Extractor/venv/lib '
              '-L/workspaces/LLM-Invoice-Extractor/venv/lib '
              ''
              ''
              '-Wl,-rpath,/workspaces/LLM-Invoice-Extractor/venv/lib '
              '-Wl,-rpath-link,/workspaces/LLM-Invoice-Extractor/venv/lib '
 ...
 'BYTESTR_DEPS': '\\',
 'CC': 'gcc -pthread -B /workspaces/LLM-Invoice-Extractor/venv/compiler_compat',
 'CCSHARED': '-fPIC',
 'CFLAGS': '-fno-strict-overflow -DNDEBUG -O2 -Wall  '
           '-fPIC  '
           '-O2   -isystem '
           '/workspaces/LLM-Invoice-Extractor/venv/include '
           ''
           ''
           ''
           '-fPIC '
 ...
 'CONFIGURE_CPPFLAGS': '-DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem '
                       '/workspaces/LLM-Invoice-Extractor/venv/include '
                       '-I/workspaces/LLM-Invoice-Extractor/venv/include',
 'CONFIGURE_LDFLAGS': ''
                      ''
                      '-Wl,-rpath,/workspaces/LLM-Invoice-Extractor/venv/lib '
                      '-Wl,-rpath-link,/workspaces/LLM-Invoice-Extractor/venv/lib '
 ...
 'CONFIG_ARGS': "'--prefix=/workspaces/LLM-Invoice-Extractor/venv'"
                "'--build=x86_64-conda_cos6-linux-gnu'"
                "'--host=x86_64-conda_cos6-linux-gnu''--enable-ipv6'"
                "'--with-ensurepip=no'"
                "'--with-tzpath=/workspaces/LLM-Invoice-Extractor/venv/share/zoneinfo:/workspaces/LLM-Invoice-Extractor/venv/share/tzinfo'"
                "'--with-computed-gotos''--with-system-expat'"
                "'--enable-loadable-sqlite-extensions'"
                "'--with-tcltk-includes=-I/workspaces/LLM-Invoice-Extractor/venv/include'"
                "'--with-tcltk-libs=-L/workspaces/LLM-Invoice-Extractor/venv/lib "
                ...
                "'PKG_CONFIG_PATH=/workspaces/LLM-Invoice-Extractor/venv/lib/pkgconfig'"
 ...
 'CONFINCLUDEDIR': '/workspaces/LLM-Invoice-Extractor/venv/include',
 'CONFINCLUDEPY': '/workspaces/LLM-Invoice-Extractor/venv/include/python3.12',
 'COREPYTHONPATH': '',
 ...
 'CPPFLAGS': '-IObjects -IInclude -IPython -I. '
             ...
             '/workspaces/LLM-Invoice-Extractor/venv/include '
             '-I/workspaces/LLM-Invoice-Extractor/venv/include',
 'CXX': 'g++ -pthread -B /workspaces/LLM-Invoice-Extractor/venv/compiler_compat',
 ...
 'DESTDIRS': '/workspaces/LLM-Invoice-Extractor/venv '
             '/workspaces/LLM-Invoice-Extractor/venv/lib '
             '/workspaces/LLM-Invoice-Extractor/venv/lib/python3.12 '
             '/workspaces/LLM-Invoice-Extractor/venv/lib/python3.12/lib-dynload',
 'DESTLIB': '/workspaces/LLM-Invoice-Extractor/venv/lib/python3.12',
 'DESTPATH': '',
 'DESTSHARED': '/workspaces/LLM-Invoice-Extractor/venv/lib/python3.12/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'EXE': '',
 'EXEMODE': 755,
 'EXENAME': '/workspaces/LLM-Invoice-Extractor/venv/bin/python3.12',
 'EXPORTSFROM': '',
 'EXPORTSYMS': '',
 'EXTRATESTOPTS': '',
 ...
 'INCLDIRSTOMAKE': '/workspaces/LLM-Invoice-Extractor/venv/include '
                   '/workspaces/LLM-Invoice-Extractor/venv/include '
                   '/workspaces/LLM-Invoice-Extractor/venv/include/python3.12 '
                   '/workspaces/LLM-Invoice-Extractor/venv/include/python3.12',
 'INCLUDEDIR': '/workspaces/LLM-Invoice-Extractor/venv/include',
 'INCLUDEPY': '/workspaces/LLM-Invoice-Extractor/venv/include/python3.12',
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': 'g++ -pthread -B /workspaces/LLM-Invoice-Extractor/venv/compiler_compat -shared',
 'LDFLAGS': ''
            ''
            '-Wl,-rpath,/workspaces/LLM-Invoice-Extractor/venv/lib '
            '-Wl,-rpath-link,/workspaces/LLM-Invoice-Extractor/venv/lib '
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -pthread -B /workspaces/LLM-Invoice-Extractor/venv/compiler_compat -shared  '
             ''
             ''
             '-Wl,-rpath,/workspaces/LLM-Invoice-Extractor/venv/lib '
             '-Wl,-rpath-link,/workspaces/LLM-Invoice-Extractor/venv/lib '
 ...
 'LDVERSION': '3.12',
 'LIBC': '',
 'LIBDEST': '/workspaces/LLM-Invoice-Extractor/venv/lib/python3.12',
 'LIBDIR': '/workspaces/LLM-Invoice-Extractor/venv/lib',
 ...
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/workspaces/LLM-Invoice-Extractor/venv/lib/pkgconfig',
 'LIBPL': '/workspaces/LLM-Invoice-Extractor/venv/lib/python3.12/config-3.12-x86_64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'LIBSUBDIRS': 'asyncio \\',
 'LINKCC': 'gcc -pthread -B /workspaces/LLM-Invoice-Extractor/venv/compiler_compat',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/workspaces/LLM-Invoice-Extractor/venv/lib/python3.12',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 1,
 'MAKESETUP': '/croot/python-split_1696267002197/work/Modules/makesetup',
 'MANDIR': '/workspaces/LLM-Invoice-Extractor/venv/share/man',
 ...
 'MODULE_BINASCII_CFLAGS': '-DUSE_ZLIB_CRC32 '
                           '-I/workspaces/LLM-Invoice-Extractor/venv/include',
 'MODULE_BINASCII_LDFLAGS': '-L/workspaces/LLM-Invoice-Extractor/venv/lib '
                            '-lz',
 ...
 'MODULE_ZLIB_CFLAGS': '-I/workspaces/LLM-Invoice-Extractor/venv/include',
 'MODULE_ZLIB_LDFLAGS': '-L/workspaces/LLM-Invoice-Extractor/venv/lib '
                        '-lz',
 ...
 'MODULE__CTYPES_LDFLAGS': '-L/workspaces/LLM-Invoice-Extractor/venv/lib '
                           '-lffi -ldl',
 ...
 'MODULE__CURSES_CFLAGS': '-D_GNU_SOURCE -DNCURSES_WIDECHAR '
                          '-I/workspaces/LLM-Invoice-Extractor/venv/include/ncursesw '
                          '-I/workspaces/LLM-Invoice-Extractor/venv/include',
 'MODULE__CURSES_LDFLAGS': '-L/workspaces/LLM-Invoice-Extractor/venv/lib '
                           ''
                           ''
                           '-Wl,-rpath,/workspaces/LLM-Invoice-Extractor/venv/lib '
                           '-Wl,-rpath-link,/workspaces/LLM-Invoice-Extractor/venv/lib '
 ...
 'MODULE__CURSES_PANEL_CFLAGS': '-D_GNU_SOURCE -DNCURSES_WIDECHAR '
                                ...
                                '-I/workspaces/LLM-Invoice-Extractor/venv/include/ncursesw '
                                '-I/workspaces/LLM-Invoice-Extractor/venv/include',
 'MODULE__CURSES_PANEL_LDFLAGS': '-L/workspaces/LLM-Invoice-Extractor/venv/lib '
                                 ''
                                 ''
                                 '-Wl,-rpath,/workspaces/LLM-Invoice-Extractor/venv/lib '
                                 '-Wl,-rpath-link,/workspaces/LLM-Invoice-Extractor/venv/lib '
 ...
 'MODULE__HASHLIB_CFLAGS': '-I/workspaces/LLM-Invoice-Extractor/venv/include',
 'MODULE__HASHLIB_DEPS': '/croot/python-split_1696267002197/work/Modules/hashlib.h',
 'MODULE__HASHLIB_LDFLAGS': '-L/workspaces/LLM-Invoice-Extractor/venv/lib   '
                            '-lcrypto',
 ...
 'MODULE__LZMA_CFLAGS': '-I/workspaces/LLM-Invoice-Extractor/venv/include',
 'MODULE__LZMA_LDFLAGS': '-L/workspaces/LLM-Invoice-Extractor/venv/lib '
                         '-llzma',
 ...
 'MODULE__SQLITE3_CFLAGS': '-I/workspaces/LLM-Invoice-Extractor/venv/include '
 ...
 'MODULE__SQLITE3_LDFLAGS': '-L/workspaces/LLM-Invoice-Extractor/venv/lib '
                            '-lsqlite3',
 'MODULE__SQLITE3_STATE': 'yes',
 'MODULE__SRE_LDFLAGS': '',
 'MODULE__SSL_CFLAGS': '-I/workspaces/LLM-Invoice-Extractor/venv/include',
 ...
 'MODULE__SSL_LDFLAGS': '-L/workspaces/LLM-Invoice-Extractor/venv/lib  '
                        '-lssl -lcrypto',
 ...
 'MODULE__TKINTER_CFLAGS': '-I/workspaces/LLM-Invoice-Extractor/venv/include '
                           '-Wno-strict-prototypes -DWITH_APPINIT=1',
 'MODULE__TKINTER_LDFLAGS': '-L/workspaces/LLM-Invoice-Extractor/venv/lib '
 ...
 'MODULE__UUID_CFLAGS': '-I/workspaces/LLM-Invoice-Extractor/venv/include/uuid',
 'MODULE__UUID_LDFLAGS': '-L/workspaces/LLM-Invoice-Extractor/venv/lib '
                         '-luuid',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/workspaces/LLM-Invoice-Extractor/venv/lib',
 ...
 'TIMEMODULE_LIB': 0,
 'TM_IN_SYS_TIME': 0,
 'TZPATH': '/workspaces/LLM-Invoice-Extractor/venv/share/zoneinfo:/workspaces/LLM-Invoice-Extractor/venv/share/tzinfo',
 'UNICODE_DEPS': '\\',
 'UNIVERSALSDK': '',
 ...
 'WASM_ASSETS_DIR': './workspaces/LLM-Invoice-Extractor/venv',
 'WASM_STDLIB': './workspaces/LLM-Invoice-Extractor/venv/lib/python3.12/os.py',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 1,
 ...
 'datarootdir': '/workspaces/LLM-Invoice-Extractor/venv/share',
 'exec_prefix': '/workspaces/LLM-Invoice-Extractor/venv',
 'prefix': '/workspaces/LLM-Invoice-Extractor/venv',
